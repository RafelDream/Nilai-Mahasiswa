...
<head>
    ...
    <style>
        body {
            ...
            font-weight: <weight>;
            font-style: normal;
            background: radial-gradient(circle, rgba(212,58,110,1) 0%, rgba(244,220,165,1) 100%);
        }
        ...
        .konten {
            ...
            background: linear-gradient(90deg, rgba(255, 248, 232, 1) 1%, rgba(255, 248, 232, 1) 46%, rgba(211, 247, 242, 1) 63%);
            border-radius: 10px;
            padding: 20px;
